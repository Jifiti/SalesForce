...
var jsFiles = () => {
    ...
    UICartridges.forEach(cartridge => {
        const sourceFiles = shell.ls(path.join(cwd, `./cartridges/${cartridge}/cartridge/client/**/js/*.js`));

        sourceFiles.forEach(filePath => {
            let location = path.relative(path.join(cwd, `./cartridges/${cartridge}/cartridge/client`), filePath);
...
var scssFiles = () => {
    ...
    UICartridges.forEach(cartridge => {
        const sourceFiles = shell.ls(path.join(cwd, `./cartridges/${cartridge}/cartridge/client/**/scss/**/*.scss`));
